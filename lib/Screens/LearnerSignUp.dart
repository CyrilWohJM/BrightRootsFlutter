                  ...
                  child: Container(
                    ...
                    child: Column(
                      children: <Widget>[
                        ...
                        SizedBox(height: 30),
                        LearnerEditTextStyle(learner_hint_full_name, TextInputType.text, isPassword: false),
                        SizedBox(height: 16),
                        LearnerEditTextStyle(learner_hint_email, TextInputType.emailAddress, isPassword: false),
                        SizedBox(height: 16),
                        LearnerEditTextStyle(learner_hint_password, TextInputType.text, isPassword: true),
                        SizedBox(height: 50),
                        Container(
                          width: 120,
                          alignment: Alignment.center,
